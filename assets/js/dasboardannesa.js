...
function MostrarRegistros2(Registros) {
  ...
  Registros.forEach(registro => {
    ...
    const divInversionPublicitariaTiktok = document.createElement("div");
    divInversionPublicitariaTiktok.classList.add("fila");
    ...
    const labelInversionPublicitariaTiktok = document.createElement("label");
    labelInversionPublicitariaTiktok.textContent = "Inversión Publicitaria";
    ...
    const inputOnlyReadInversionPublicitariaTikTok = document.createElement("input");
    inputOnlyReadInversionPublicitariaTikTok.type = "number";
    inputOnlyReadInversionPublicitariaTikTok.value = registro.inversionPublicitariaTikTok;
    inputOnlyReadInversionPublicitariaTikTok.readOnly = true;
    ...
    divInversionPublicitariaTiktok.appendChild(labelInversionPublicitariaTiktok);
    divInversionPublicitariaTiktok.appendChild(inputOnlyReadInversionPublicitariaTikTok);
    ...
    containerRegistro.appendChild(divInversionPublicitariaTiktok);
...
function mostrarPopUpEditarRegistro(registro) {
  ...
  formEditar.innerHTML = `
                ...
                <div class="fila">
                  ...
                  <div class="fila">
                    <label for="email">Inversión Publicitaria</label>
                    <input type="number" name="inversionPublicitariaTikTok" id="inversionPublicitariaTikTok" value=${registro.inversionPublicitariaTikTok}>
                </div>
