        ...
        <div class="container">
            <form action="" method="post" id="formulario">
                ...
                <div class="fila-ads">
                    ...
                    <input class="ads" type="number" name="seguidoresdelmesfbads" id="seguidoresdelmesfbads"
                        placeholder="ads">
                </div>
                <div class="fila">
                ...
                <div class="fila-ads">
                    ...
                    <input type="number" name="interracionesconelcontenidofb" id="interracionesconelcontenidofb"
                        placeholder="Agregar dato del mismo mes 2024">
                    <input type="number" class="ads" name="interracionesconelcontenidofbads"
                        id="interracionesconelcontenidofbads" placeholder="ads">
                </div>

                <div class="fila-ads">
                    <label for="email">Clics en enlace</label>
                    <input type="number" name="clicsenelalcancefb" id="clicsenelalcancefb"
                        placeholder="Agregar dato del mismo mes 2024">
                    <input type="number" class="ads" name="clicsenelalcancefbads" id="clicsenelalcancefbads"
                        placeholder="ads">
                </div>
                <div class="fila">
                ...
                <div class="fila-ads">
                    <label for="email">Interacciones con el contenido</label>
                    <input type="number" name="interaccionesconelcontenidoig" id="interaccionesconelcontenidoig"
                        placeholder="Agregar dato del mismo mes 2024">
                    <input type="number" class="ads" name="interaccionesconelcontenidoigads"
                        id="interaccionesconelcontenidoigads" placeholder="ads">
                </div>
                <div class="fila-ads">
                    <label for="email">Clics en enlace</label>
                    <input type="number" name="clicsenelalcanceig" id="clicsenelalcanceig"
                        placeholder="Agregar dato del mismo mes 2024">
                    <input type="number" class="ads" name="clicsenelalcanceigads" id="clicsenelalcanceigads"
                        placeholder="ads">
                </div>
                <div class="fila">
                    <label for="email">Inversión Publicitaria</label>
